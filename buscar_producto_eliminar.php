...
<head>
    ...
    <title>Buscar Producto para Eliminar - SERVIPARTES</title>
...
<body>
    <div class="form-container">
        ...
        <form action="confirmar_eliminar_producto.php" method="get">
            <div class="mb-3">
                <label for="busqueda">ID del Producto o Nombre:</label>
