...
<head>
    ...
    <title>Confirmar Eliminar Proveedor - SERVIPARTES</title>
...
<body>
    <div class="form-container">
        <?php if ($proveedor): ?>
            <h1>¿Eliminar este proveedor?</h1>
            
            <div class="proveedor-info">
                <p><strong>ID:</strong> <?php echo htmlspecialchars($proveedor['ID Proveedor']); ?></p>
            ...
            <form action="eliminar_proveedor.php" method="post">
                <input type="hidden" name="id_proveedor" value="<?php echo htmlspecialchars($proveedor['ID Proveedor']); ?>">
        ...
        <?php else: ?>
            ...
            <p>No se encontró ningún proveedor con los criterios de búsqueda.</p>
            <button type="button" class="btn-cancelar" onclick="window.location.href='buscar_proveedor_eliminar.php'">Volver</button>
        <?php endif; ?>
    </div>
</body>
</html>