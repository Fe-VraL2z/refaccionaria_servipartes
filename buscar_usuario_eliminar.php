...
<head>
    ...
    <title>Buscar Usuario para Eliminar - SERVIPARTES</title>
...
<body>
    <div class="form-container">
        <h1>Buscar Usuario para Eliminar</h1>
        <form action="confirmar_eliminar_usuario.php" method="get">
            <div class="mb-3">
                <label for="busqueda">ID Usuario o Nombre:</label>
