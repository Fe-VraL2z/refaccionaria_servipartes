...
<head>
    ...
    <title>Buscar Cliente para Eliminar - SERVIPARTES</title>
...
<body>
    <div class="form-container">
        <h1>Buscar Cliente para Eliminar</h1>
        <form action="confirmar_eliminar.php" method="get">
            <div class="mb-3">
                <label for="busqueda">ID del cliente o Nombre:</label>
